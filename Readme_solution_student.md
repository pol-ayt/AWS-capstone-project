...
- Origin Settings
```text
Origin Domain Name          : blog-ALB-3467210805.us-east-2.elb.amazonaws.com
Origin Path                 : Leave empty (this means, define for root '/')
Protocol                    : Match Viewer
HTTP Port                   : 80
HTTPS                       : 443
Minimum Origin SSL Protocol : Don't change
Name                        : Don't change
Add custom header           : No header
Enable Origin Shield        : No
Additional settings         : Don't change
```
Default Cache Behavior Settings
```text
Path pattern                                : Default (*)
WAFpress objects automatically              : Yes
...
Alternate Domain Names                  : www.polatclick.click
...
- click your Hosted zone        : polatdevops.click
...
```text
Configure records
Record name             : www.polatdevops.com
...
Role description    : This role permits lambda to reach S3 and DynamoDB on custom VPC
```
